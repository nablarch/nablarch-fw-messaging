...
public class MessageSenderTest {
    ...
    public void testMessageBody() {
        ...
        ********************************************************/
        ...
        assertThat(responseMessage.getHeaderRecord().get("resendFlag").toString(), is(""));
    ...
    public void testRealtimeMessageBody() {
        ...
        //HTTP通信のみが設定する項目を確認する。
        assertThat((String)reciveMessage.getHeaderRecord().get(HttpMessagingClient.SYNCMESSAGE_STATUS_CODE), is("200"));
